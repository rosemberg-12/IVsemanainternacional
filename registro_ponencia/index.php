...
$fecha_entrada = strtotime("08-10-2017 11:50:00");
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="../ponencia.html">PONENCIAS</a></li>
             <li class="dropdown">
...
if( ($visible==0) && ($fecha_actual > $fecha_entrada)){?>
     ...
     Estimado usuario, la convocatoria al evento de La VI Semana Internacional y XII Semana de Ciencia,
     Tecnolog&iacute;a e Innovaci&oacute;n que se desarrollar&aacute; del 07 al 10 de Noviembre del 2017, finaliz&oacute; 
     su proceso de inscripci&oacute;n el 01 de octubre a las 11:50 pm.
    <br /><br /><br>
	 	...
	 	<div class="row">
	 		<div class="col-lg-8">	 			
		 		<form role="form" method="post" enctype="multipart/form-data" target="_parent"  action="controller/ponencia.php" name="fcontacto" >
					  ...
					  <div class="form-group">
					  	<label>Anexo Resumen de Ponencia(M&aacute;ximo 7MB):<span title="Campo Obligatorio" style="color: red; font-size: 13pt;">*</span></label>
